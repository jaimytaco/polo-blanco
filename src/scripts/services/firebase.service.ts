...
export class Firebase {
    ...
    //     const { initializeApp } = await import(isBrowser() || isWorker() ? this.FIREBASE_APP_JS : this.FIREBASE_APP_NODE)
    //     const { getFirestore } = await import(isBrowser() || isWorker() ? this.FIREBASE_FIRESTORE_JS : this.FIREBASE_FIRESTORE_NODE)
    ...
    //     const { collection, getDocs } = await import(isBrowser() || isWorker() ? this.FIREBASE_FIRESTORE_JS : this.FIREBASE_FIRESTORE_NODE)

    //     try {
    //         const q = collection(this.firestore, collectionName)
